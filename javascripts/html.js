    ...
    sort: function (id) {
      ...
      if (typeof (TS.data.chosenFile[id]) === "object") {
        for (let item in TS.data.chosenFile[id]) {
          if (Object.prototype.hasOwnProperty.call(TS.data.chosenFile[id], item)) {
    ...
    renderedList: function (id) {
      ...
      let determine = function (item, itemName, path, {
        ...
        if (itemName[0] === "*") {
          ...
          formatType = function (a) {
            return marked(a); // Todo: marked is not defined, check global namespace
          };
        }
        let line = Object.assign(document.createElement("div"), {
          className: "lineContainer "
        });
        line.className += typeof item === "object" ? " objectContainer" : " stringContainer";
      ...
      let select = Object.assign(document.createElement("select"), {
        onclick: function () {
          if (this.selectedIndex > 0) {
            if (this.value === "devMode") {
              window.open("devMode.html");
            } else {
              callback(this.value);
            }
